...
function Checkout() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Then redirect to the order summary page
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 outline-none block w-full rounded-md py-2 px-6 border-b border-gray-600/60 shadow-sm focus:border-green-500"
                    />
                  </div>
                  <div>
                    <label
